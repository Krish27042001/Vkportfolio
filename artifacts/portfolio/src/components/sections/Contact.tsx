...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="w-full py-24 px-6 lg:px-12 bg-background/50 relative z-10"
    >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold text-foreground group-hover:text-[#0A66C2] transition-colors">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    className="bg-background/50 border-white/10 h-12 focus-visible:ring-primary"
                  />
                </div>
